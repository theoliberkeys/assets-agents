...
async function flyer(nom, mail, metier, numero, fichier, photo) {
    ...
    // Place le nom, le métier, le numéro et le mail
    draw_Text(nom, firstPage, ((width - ppextra.widthOfTextAtSize(nom, 14)) / 2), 329, 14, ppextra, marron)
    draw_Text(meilleure, firstPage, ((width - ppregu.widthOfTextAtSize(meilleure, 20)) / 2), 396, 20, ppregu, marron)
    draw_Text(allie, firstPage, ((width - ppregu.widthOfTextAtSize(allie, 20)) / 2), 369, 20, ppregu, marron)
    draw_Text(metier, firstPage, ((width - ppregu.widthOfTextAtSize(metier, 14)) / 2), 310, 14, ppregu, marron)
    draw_Text(numero, firstPage, ((width - ppregu.widthOfTextAtSize(numero, 14)) / 2), 287, 14, ppregu, marron)
    draw_Text(mail, firstPage, ((width - ppregu.widthOfTextAtSize(mail, 14)) / 2), 265, 14, ppregu, marron)
